...
$(function () {
        ...
        function multilevel_menu() {
            $(".stair-menus").click(function () {
                ...
                $(this).siblings().children(".OA-an").hide().prev().show()
            });
...
//
        ...
        add_planned();
        function add_planned() {
            $(".OA-add").click(function () {
                $(".tab-left").append("<div id='"+counts+"' class='addtab'><a href='#'>添加计划</a><i  class='OA-shut'></i></div>");
                $(".flavoureds").show().siblings(".revamps,.revisions,.queue").hide()
            });
            $(".OA-writing").click(function () {
                $(".tab-left").append("<div id='"+counts+"' class='addtab'><a href='#'>修改计划</a><i  class='OA-shut'></i></div>");
                $(".revisions").show().siblings(".revamps,.flavoureds,.queue").hide()
            })
        }
    });